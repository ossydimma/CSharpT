using System.Numerics; // To use big integer

// working with big intrgers
const int width = 40;
...
// working with random and its methods 
...
//working with random getitems and shuffles methods
...
//working with globally unique identifier(GUID)
